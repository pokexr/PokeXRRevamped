...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.ARStarterAssets
{
    ...
    public class ARInteractorSpawnTrigger : MonoBehaviour
    {
        ...
        UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor m_ARInteractor;

        /// <summary>
        /// The AR ray interactor that determines where to spawn the object.
        /// </summary>
        public UnityEngine.XR.Interaction.Toolkit.Interactors.XRRayInteractor arInteractor
        {
            get => m_ARInteractor;
        ...
        void Start()
        {
            ...
            {
                Debug.Log("ARInteractorSpawnTrigger is enabled");
            }
        }
