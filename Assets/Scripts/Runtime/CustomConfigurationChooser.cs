...
namespace UnityEngine.XR.ARFoundation.Samples
{
    public class CustomConfigurationChooser : MonoBehaviour
    {
        ...
        public Dropdown m_ConfigDropdown;
        public int StartModeIndex = 1;
        ...
        /// </summary>
        ConfigurationChooserMode m_ConfigurationChooserMode = ConfigurationChooserMode.PreferCamera;

        void Start()
        {
            Debug.Log("CustomConfigurationChooser:Start(): Start mode is " + Enum.GetName(typeof(ConfigurationChooserMode), StartModeIndex));
            // m_ConfigurationChooserMode = (ConfigurationChooserMode)StartModeIndex;
            m_ConfigDropdown.value = StartModeIndex;
